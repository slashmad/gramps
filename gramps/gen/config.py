...
register("preferences.callname-list-highlight-bold", False)
register("preferences.callname-list-highlight-underline", False)
...
register("preferences.notrelated-include-partner-links", True)
